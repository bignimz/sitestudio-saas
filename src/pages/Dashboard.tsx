              ...
              >
                ...
                <form onSubmit={handleCreateProject} className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">Enter any website URL to start editing</p>
                  </div>
        ...
        {loading ? (
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">
              {searchQuery ? "Try adjusting your search query" : "Create your first project by importing a website URL"}
            </p>
            {!searchQuery && (
              <button
                onClick={() => setShowCreateForm(true)}
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-xs">
                    <div
                      className={`w-2 h-2 rounded-full ${project.is_published ? "bg-green-500" : "bg-gray-400"}`}
                    ></div>
                    <span className="text-gray-600">{project.is_published ? "Published" : "Draft"}</span>
                  </div>
                </div>
