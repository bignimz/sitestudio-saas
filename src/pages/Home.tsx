    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
          ...
          <div className="text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                Transform static websites into dynamic, editable experiences with our AI-powered visual editor. No
                coding required - just point, click, and create.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Get intelligent layout and design suggestions powered by advanced AI to improve your website's UX and
                conversion rates.
              </p>
            </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Transform Your Websites?</h2>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-gray-400 max-w-md">
                Transform any static website into a dynamic, editable experience with AI-powered suggestions and visual
                editing tools.
              </p>
            </div>
